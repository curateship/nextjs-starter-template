...
export function DefaultDirectoryContentRenderer({ config, sharedContent }: DirectoryContentStyleRendererProps) {
  ...
  // Use body from block content, fall back to directory description
