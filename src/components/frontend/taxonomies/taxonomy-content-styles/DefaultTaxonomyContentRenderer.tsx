import type { TaxonomyContentStyleRendererProps } from "./index"

export function DefaultTaxonomyContentRenderer({ config, sharedContent }: TaxonomyContentStyleRendererProps) {
  ...
  // Use body from block content, fall back to taxonomy description
