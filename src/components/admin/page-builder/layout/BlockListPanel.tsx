...
import { Trash2, GripVertical, Zap, FileText, Navigation, Mouse, HelpCircle, LayoutGrid, Minus, Eye, LogIn, User, Code, Quote, Plus } from "lucide-react"
import {
  DndContext,
  closestCenter,
  KeyboardSensor,
          ...
          {blocksLoading ? (
            ...
            <div className="text-center py-12">
              <div className="text-muted-foreground mb-4">
                ...
                <p className="text-xs">Click "Add Blocks" in the header to start building your page</p>
              </div>
            </div>
          ) : (
            <DndContext
