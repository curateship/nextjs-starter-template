...
interface DirectoryDefaultBlockProps {
  title: string
  richText: string
...
export function DirectoryDefaultBlock({
  title,
  richText,
  featuredImage,
  status = 'draft',
      ...
      <Card className="shadow-sm">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-2">
            <label className="text-sm font-medium">Directory Title</label>
            <Input
              value={title}
          ...
          {/* Rich Text Editor */}
          <div className="space-y-2">
            <label className="text-sm font-medium">Directory Description</label>
