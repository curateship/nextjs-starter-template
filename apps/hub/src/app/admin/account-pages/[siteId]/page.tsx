    ...
    async function loadData() {
      try {
        ...
        const {
          ...
          total: pagesTotal,
          error: pagesError
        } = await getAccountPagesAction(siteId, {
          page: currentPage,
          pageSize
        })
        if (pagesError) {
  ...
  return (
    <>
      ...
      <AdminLayout>
        <div className="w-full">
          <DashboardSubheader
            items={[{ label: "Pages", href: `/admin/sites/${siteId}/pages` }, { label: "Account Pages" }]}
            search={{
              value: searchQuery,
                    ...
                    <div className="grid grid-cols-5 gap-4 items-center">
                        ...
                        <div className="flex items-center space-x-4">
                          ...
                          >
                            ...
                            <div>
                              ...
                              <p className="text-sm text-muted-foreground">{getAccountPagePath(page.slug)}</p>
                            </div>
                          </Link>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center space-x-1">
                        ...
                        <Button variant="ghost" size="sm" className="h-8 w-8 p-0" asChild>
                          <a
                            href={site ? `${getSiteUrl(site)}${getAccountPagePath(page.slug)}` : "#"}
                            target="_blank"
