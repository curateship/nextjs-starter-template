...
export async function getEventTemplatesBySite(
  siteId: string,
...
export async function getEventTemplateIdsAction(siteId: string): Promise<{ ids: string[]; error: string | null }> {
...
export async function setDefaultEventTemplate(templateId: string): Promise<{ success: boolean; error: string | null }> {
...
export async function deleteEventTemplates(ids: string[]): Promise<{ success: boolean; error: string | null }> {
