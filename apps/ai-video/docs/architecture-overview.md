...
Today, `ai-video` is a small Vite + React + TypeScript app using `shadcn/ui` primitives, a shared sidebar/header layout, and a config-driven shell model through `ShellConfig`.
