...
// so a timeline saved before this feature validates unchanged.
//
// This module is the single source of truth shared by the schema, the editor
// preview and the inspector, so they all agree on which seams carry a
// transition and how long it lasts.
