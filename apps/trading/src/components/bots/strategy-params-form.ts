  ...
  switch (strategy) {
    ...
    case "qqe":
      return {
        ...
        paintSwings: values.paintSwings === "true",
        swingLookback: num("swingLookback"),
        swingStopLoss: values.swingStopLoss === "true",
        swingScanBars: num("swingScanBars"),
        swingConfirmBars: num("swingConfirmBars"),
