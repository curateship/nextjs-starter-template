/** Deliberate Trade-owned fork of the shell node icon wrapper. */
import type { AutomationNodeIcon as NodeIcon } from "@/lib/recipes/registry"
 ...
 */
export function RecipeNodeIcon({
  icon: Icon,
  className,
}: {
  icon: NodeIcon
