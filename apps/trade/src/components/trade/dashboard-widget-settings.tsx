  ...
  return (
    <>
      ...
      <ConfirmDialog
        ...
        description="The figures return to the top, Wallets and Money over time return to the left, and All trades returns to the right. The platform Overview is not changed. This cannot be undone."
