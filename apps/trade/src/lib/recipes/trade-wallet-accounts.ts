 ...
 * request.
 */
export type RecipeWalletAccounts = {
  at: number
  wallets: TradeWallet[]
...
let cached: RecipeWalletAccounts | null = null
let inFlight: Promise<RecipeWalletAccounts> | null = null

/** The last wallet answer already in memory, without starting a request. */
export function readRecipeWalletAccounts(): RecipeWalletAccounts | null {
  return cached
}
 ...
 * slow exchange read.
 */
export function loadRecipeWalletAccounts(
  fresh = false
): Promise<RecipeWalletAccounts> {
