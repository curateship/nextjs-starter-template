...
/**
 * The Aster dashboard. Every exchange gets a page of exactly this
 * shape — same panels, same loader, its own address — and market lists from
 * different exchanges are never combined into one list.
 *
 * The one thing that makes this page Aster's is the constant below. It
 * is held as DATA and handed to `loadMarkets`; nothing here ever asks "is
 * this Aster?", which is the comparison the protocol fence exists to
