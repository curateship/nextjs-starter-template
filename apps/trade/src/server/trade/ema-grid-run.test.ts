...
describe("waiting and refusals", () => {
  it("places custom rung weights whatever they add up to", async () => {
    // Tyler's rule, clarified 3 Sep 2026: rows adding to 90 still divide the
    // complete grid pot rather than causing a refusal.
