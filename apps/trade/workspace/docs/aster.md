...
- An order that must fill now is still a limit: Trade caps it three percent
  through the mark or inside Aster's stated price band, whichever is closer.
  Trade leaves five percent of that band unused for price movement, snaps the
  cap to the market's legal price step and sends it Immediate-or-Cancel. Aster
  may fill inside that cap or cancel the rest; it never receives a naked market
  entry from Trade.
