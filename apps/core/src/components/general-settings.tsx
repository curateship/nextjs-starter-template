  ...
  return (
    <CardGroup>
      <CollapsibleSettingsCard
        ...
        description="Set the workspace name and favicon used by Core."
      ...
      >
        ...
        <div className="grid gap-2">
          ...
          <Input
            ...
            placeholder="Leave empty for Datasource"
          />
          <p className="text-xs text-muted-foreground">
            Where the home page (<code>/</code>) and <code>/admin</code> open
            (e.g. <code>/admin/media</code>). Empty opens Datasource. Must be
            a real route — an unknown path will 404.
          </p>
        </div>
