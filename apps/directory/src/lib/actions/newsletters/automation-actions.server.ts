...
export async function getAutomationsBySiteImpl(siteId: string, options?: { page?: number; pageSize?: number }): Promise<{ data: EmailAutomation[] | null; total: number; error: string | null }> {
  try {
...
export async function getAutomationByIdImpl(automationId: string): Promise<{ data: EmailAutomation | null; steps: AutomationStep[] | null; error: string | null }> {
  try {
...
export async function getAutomationJourneyIndicatorsImpl(automationId: string): Promise<{
...
export async function createAutomationImpl(input: {
  siteId: string
  name: string
  description?: string
...
export async function deleteAutomationsImpl(ids: string[]): Promise<{ success: boolean; error: string | null }> {
  try {
...
export async function createStepImpl(input: {
  automationId: string
  stepOrder: number
...
export async function reorderStepsImpl(automationId: string, stepIds: string[]): Promise<{ success: boolean; error: string | null }> {
  try {
...
export async function getStepByIdImpl(stepId: string): Promise<{ data: AutomationStep | null; error: string | null }> {
  try {
...
export async function updateStepImpl(
  stepId: string,
...
export async function deleteStepImpl(stepId: string): Promise<{ success: boolean; error: string | null }> {
  try {
    ...
    const compactResult = await reorderStepsImpl(step.automationId, remainingSteps.map(s => s.id))
...
export async function getAutomationReportImpl(automationId: string): Promise<{
...
export async function getAutomationStepStatusEventsImpl(
  automationId: string,
  stepOrder: number,
