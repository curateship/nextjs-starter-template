...
export async function createOrUpsertContactImpl(input: {
  siteId: string
  email: string
  firstName?: string
  lastName?: string
...
export async function bulkImportContactsImpl(input: {
  siteId: string
...
export async function deleteContactsImpl(contactIds: string[]): Promise<{ success: boolean; error: string | null }> {
  try {
...
export async function getContactsWithStatsImpl(
  siteId: string,
  options?: {
...
export async function getContactByIdImpl(
  contactId: string
): Promise<{ data: CrmContact | null; error: string | null }> {
  try {
    if (!UUID_REGEX.test(contactId)) return { data: null, error: 'Invalid contact ID' }
...
export async function getContactStatsImpl(
  contactId: string
...
export async function getContactEventsImpl(
  contactId: string,
  page = 1,
  pageSize = 20
...
export async function getContactSegmentsImpl(
  contactId: string
...
export async function getContactClickedLinksImpl(
  contactId: string
...
export async function getContactEngagementOverTimeImpl(
  contactId: string
...
export async function unsubscribeContactImpl(
  siteId: string,
  email: string,
  token: string,
  newsletterId?: string
