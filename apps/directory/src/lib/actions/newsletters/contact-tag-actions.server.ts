...
export async function getNewsletterContactTagsImpl(
  siteId: string,
...
export async function renameNewsletterContactTagImpl(
  siteId: string,
  fromTag: string,
  toTag: string
...
export async function deleteNewsletterContactTagsImpl(
  siteId: string,
  tags: string[]
): Promise<{ updated: number; error: string | null }> {
  try {
