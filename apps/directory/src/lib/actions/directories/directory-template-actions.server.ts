...
export async function getDirectoryTemplatesBySiteImpl(
  siteId: string,
...
export async function getDirectoryTemplateIdsActionImpl(siteId: string): Promise<{ ids: string[]; error: string | null }> {
  return getTemplateIds(directoryTemplates, 'getDirectoryTemplateIdsAction', siteId)
}

export async function getDirectoryTemplateByIdImpl(
  templateId: string
...
export async function createDirectoryTemplateImpl(input: {
  siteId: string
  name: string
...
export async function updateDirectoryTemplateImpl(
  templateId: string,
...
export async function setDefaultDirectoryTemplateImpl(templateId: string): Promise<{ success: boolean; error: string | null }> {
...
export async function deleteDirectoryTemplatesImpl(ids: string[]): Promise<{ success: boolean; error: string | null }> {
