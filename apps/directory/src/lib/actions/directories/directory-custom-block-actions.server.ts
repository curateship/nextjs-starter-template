...
export async function getDirectoryCustomBlockByIdImpl(templateId: string): Promise<{ data: DirectoryCustomBlockTemplate | null; error: string | null }> {
  try {
...
export async function createDirectoryCustomBlockImpl(input: {
  siteId: string
  name: string
...
export async function updateDirectoryCustomBlockImpl(templateId: string, updates: {
  name?: string
  layout?: DirectoryCustomBlockLayout
  fields?: any[]
}): Promise<{ data: DirectoryCustomBlockTemplate | null; error: string | null }> {
...
export async function deleteDirectoryCustomBlockImpl(templateId: string): Promise<{ success: boolean; error: string | null }> {
  try {
...
export type { DirectoryCustomBlockLayout }
