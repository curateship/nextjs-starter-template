...
export async function getDirectorySaveStateActionImpl(input: {
  siteId: string
  directoryId: string
}): Promise<{
...
export async function toggleDirectorySaveCollectionActionImpl(input: {
  siteId: string
  directoryId: string
...
export async function createDirectorySaveCollectionActionImpl(input: {
  siteId: string
  directoryId: string
  name: string
}): Promise<{
...
export async function getMySavedCollectionsActionImpl(siteId: string): Promise<{
...
export async function getDirectorySaveFoldersDashboardActionImpl(input: {
  siteId: string
  page?: number
  pageSize?: number
  query?: string
...
export async function getDirectorySaveFolderItemsDashboardActionImpl(input: {
  siteId: string
  collectionId: string
  page?: number
  pageSize?: number
...
export async function updateDirectorySaveDefaultCollectionsActionImpl(input: {
  siteId: string
  savedLabel: string
...
export async function renameDirectorySaveCollectionDashboardActionImpl(input: {
  siteId: string
  collectionId: string
  name: string
...
export async function removeDirectorySaveCollectionsDashboardActionImpl(input: {
  siteId: string
...
export async function removeDirectorySaveItemsDashboardActionImpl(input: {
  siteId: string
  itemIds: string[]
}): Promise<{ success: boolean; error: string | null }> {
  try {
