...
export async function getDirectoryFeaturedPlansActionImpl(siteId: string): Promise<{
...
export async function saveDirectoryFeaturedPlanActionImpl(input: {
  siteId: string
  planId?: string | null
  name: string
  description?: string | null
...
export async function setDirectoryFeaturedPlanArchivedActionImpl(input: {
  siteId: string
  planId: string
  archived: boolean
}): Promise<{ success: boolean; error: string | null }> {
...
export async function getDirectoryFeaturedEntitlementsActionImpl(siteId: string, status?: DirectoryFeaturedEntitlementStatus): Promise<{
...
export async function getDirectoryFeaturedRevenueSummaryActionImpl(siteId: string): Promise<DirectoryFeaturedRevenueSummary> {
...
export async function revokeDirectoryFeaturedEntitlementActionImpl(input: {
  siteId: string
...
export async function getMyDirectoryFeaturedUpgradeStateActionImpl(siteId: string, directoryId: string): Promise<{
...
export async function createDirectoryFeaturedCheckoutActionImpl(input: {
  siteId: string
  directoryId: string
  planId: string
  returnPath?: string
 ...
 */
export async function confirmDirectoryFeaturedCheckoutActionImpl(input: {
  siteId: string
  sessionId: string
}): Promise<{ success: boolean; error: string | null }> {
  if (!UUID_REGEX.test(input.siteId)) return { success: false, error: 'Invalid site ID' }
