...
export async function getSiteSponsorsActionImpl(siteId: string): Promise<{ data: Sponsor[] | null; error: string | null }> {
  try {
...
export async function getActiveSponsorsForPickerActionImpl(siteId: string): Promise<{ data: SponsorPublic[]; error: string | null }> {
  try {
    const site = await verifySiteOwnership(siteId)
...
export async function getActiveSponsorsByIdsActionImpl(siteId: string, sponsorIds: string[]): Promise<Record<string, SponsorPublic>> {
...
export async function createSponsorActionImpl(input: SponsorInput): Promise<{ data: Sponsor | null; error: string | null }> {
  try {
...
export async function updateSponsorActionImpl(sponsorId: string, input: SponsorUpdateInput): Promise<{ data: Sponsor | null; error: string | null }> {
  try {
...
export async function deleteSponsorActionImpl(sponsorId: string): Promise<{ success: boolean; error: string | null }> {
  try {
    const sponsor = await getSponsorForUser(sponsorId)
...
export async function deleteSponsorsActionImpl(sponsorIds: string[]): Promise<{ success: boolean; error: string | null }> {
  try {
