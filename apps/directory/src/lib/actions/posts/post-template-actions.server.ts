...
export async function getPostTemplatesBySiteImpl(
  siteId: string,
...
export async function getPostTemplateIdsActionImpl(siteId: string): Promise<{ ids: string[]; error: string | null }> {
  return getTemplateIds(postTemplates, 'getPostTemplateIdsAction', siteId)
}

export async function getPostTemplateByIdImpl(
  templateId: string
): Promise<{ data: PostTemplate | null; error: string | null }> {
  return getTemplateById(postTemplates, 'getPostTemplateById', templateId)
}

export async function createPostTemplateImpl(input: {
  siteId: string
  name: string
...
export async function updatePostTemplateImpl(
  templateId: string,
...
export async function setDefaultPostTemplateImpl(templateId: string): Promise<{ success: boolean; error: string | null }> {
...
export async function deletePostTemplatesImpl(ids: string[]): Promise<{ success: boolean; error: string | null }> {
