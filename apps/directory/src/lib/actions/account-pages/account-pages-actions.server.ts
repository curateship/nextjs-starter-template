...
export type AccountPageRow = typeof siteAccountPages.$inferSelect
 ...
 */
export async function getAccountPagesActionImpl(siteId: string, options?: { page?: number; pageSize?: number; selectedSlug?: string }): Promise<{ data: AccountPage[] | null; total: number; error: string | null }> {
  try {
 ...
 * Delete account page
 */
export async function deleteAccountPageActionImpl(pageId: string): Promise<{ success: boolean; error: string | null }> {
  try {
 ...
 */
export async function deleteAccountPagesActionImpl(pageIds: string[]): Promise<{ success: boolean; error: string | null }> {
  try {
    if (!pageIds.length) {
 ...
 */
export async function updateAccountPageBlocksActionImpl(
  pageId: string,
 ...
 */
export async function duplicateAccountPageActionImpl(
  pageId: string,
  newTitle: string
): Promise<{ data: AccountPage | null; error: string | null }> {
  try {
