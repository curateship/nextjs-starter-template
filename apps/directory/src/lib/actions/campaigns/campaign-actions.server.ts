...
export async function getSiteCampaignsActionImpl(siteId: string): Promise<AdminActionResult<CampaignRecord[]>> {
  try {
...
export async function saveCampaignActionImpl(input: CampaignInput, campaignId?: string): Promise<AdminActionResult<CampaignRecord>> {
  try {
...
export async function setCampaignStatusActionImpl(campaignId: string, status: CampaignStatus): Promise<AdminActionResult<CampaignRecord>> {
  try {
...
export async function deleteCampaignActionImpl(campaignId: string): Promise<AdminActionResult<{ id: string }>> {
  try {
    const campaign = await getOwnedCampaign(campaignId)
    if (!campaign) return actionFailure('Campaign not found or access denied')
