...
export async function getSystemEmailDashboardActionImpl(siteId: string) {
  try {
...
export async function getSystemEmailEditorActionImpl(templateKeyInput: string, siteId?: string | null) {
  try {
...
export async function saveSystemEmailTemplateActionImpl(input: {
  templateKey: string
  siteId?: string | null
  subject: string
