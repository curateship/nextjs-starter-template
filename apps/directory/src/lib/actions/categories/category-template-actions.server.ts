...
export async function getCategoryTemplatesBySiteImpl(
  siteId: string,
...
export async function getCategoryTemplateIdsActionImpl(siteId: string): Promise<{ ids: string[]; error: string | null }> {
  return getTemplateIds(categoryTemplates, 'getCategoryTemplateIdsAction', siteId)
}

export async function getCategoryTemplateByIdImpl(
  templateId: string
...
export async function createCategoryTemplateImpl(input: {
  siteId: string
  name: string
...
export async function updateCategoryTemplateImpl(
  templateId: string,
...
export async function setDefaultCategoryTemplateImpl(templateId: string): Promise<{ success: boolean; error: string | null }> {
...
export async function deleteCategoryTemplatesImpl(ids: string[]): Promise<{ success: boolean; error: string | null }> {
