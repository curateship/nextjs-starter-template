...
export async function getCurrentUserImpl() {
...
export async function getMyProfileImpl() {
...
export async function updateProfileImpl(formData: FormData) {
  const authUser = await getAuthenticatedUser()
...
export async function updatePasswordImpl(formData: FormData) {
  const authUser = await getAuthenticatedUser()
  if (!authUser) return { error: 'Not authenticated' }
...
export async function requestEmailChangeImpl(formData: FormData) {
  const authUser = await getAuthenticatedUser()
  if (!authUser) return { error: 'Not authenticated' }
