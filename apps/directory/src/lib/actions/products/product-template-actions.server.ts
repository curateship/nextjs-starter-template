...
export async function getProductTemplatesBySiteImpl(
  siteId: string,
...
export async function getProductTemplateIdsActionImpl(siteId: string): Promise<{ ids: string[]; error: string | null }> {
  return getTemplateIds(productTemplates, 'getProductTemplateIdsAction', siteId)
}

export async function getProductTemplateByIdImpl(
  templateId: string
...
export async function createProductTemplateImpl(input: {
  siteId: string
  name: string
...
export async function updateProductTemplateImpl(
  templateId: string,
...
export async function setDefaultProductTemplateImpl(templateId: string): Promise<{ success: boolean; error: string | null }> {
  return setDefaultTemplate(productTemplates, 'setDefaultProductTemplate', templateId)
}

export async function deleteProductTemplatesImpl(ids: string[]): Promise<{ success: boolean; error: string | null }> {
