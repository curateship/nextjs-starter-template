...
export const hubNotifications = pgTable('hub_notifications', {
  ...
  check('hub_notifications_type_check', sql`${table.type} in ('product_order', 'directory_claim', 'directory_owner_edit', 'directory_featured', 'newsletter_paused', 'directory_featured_expired', 'event_submission')`),
