...
// Directory-only: menus portal to <body>, outside the per-site font scope, so
// the content restates the admin/site font explicitly.
const dropdownFontClassName =
