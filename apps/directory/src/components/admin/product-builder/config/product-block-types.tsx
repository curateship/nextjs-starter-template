      ...
      steps: [
        {
          ...
          title: 'Start From A Dashboard',
          description: 'Choose from our <strong>pre-made dashboards</strong> or create your own blank workspace from scratch. Elements OS gives you a clean foundation, then lets you shape it around your exact workflow.',
        },
        {
          id: 'step-detect-issues',
          image: 'https://deifkwefumgah.cloudfront.net/shadcnblocks/block/placeholder-2.svg',
          title: 'Select Your Module',
          description: 'Pick from <strong>30+ modules</strong> for products, pages, directories, events, newsletters, dashboards, and more. New modules are always being added so your system can keep growing with you.',
        },
        {
          id: 'step-stable-version',
          image: 'https://deifkwefumgah.cloudfront.net/shadcnblocks/block/placeholder-3.svg',
          title: 'Copy, Paste, And Customize',
          description: 'Drop in a block view, then customize the layout, copy, media, spacing, and style until it feels like your own. Build polished views fast without being locked into a rigid template.',
        },
      ],
      visibility: {},
    }
