        ...
        <CardContent className="space-y-6">
          ...
          <div className="grid gap-2">
            ...
            <Input
              ...
              placeholder="Leave empty for Pomoder admin"
            />
            <p className="text-xs text-muted-foreground">
              Where <code>/admin</code> opens (e.g. <code>/admin/rooms</code>).
              Empty opens the Pomoder admin dashboard. Must be a real route —
              an unknown path will 404.
            </p>
          </div>
